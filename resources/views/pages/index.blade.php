...
.basic-2{
  position: relative;
	padding-top: 7rem;
	padding-bottom: 8rem;
	background-image: url("https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWtnbmNtZ3FnNmd1MHJpMDF5b255cjBiNWVmdDJ2b2o3dDZqdGg2MCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l3q2JpzXbqdZ6ptGE/giphy.gif");
...
.basic-3{
  position: relative;
	padding-top: 7rem;
	padding-bottom: 8rem;
	background-image: url("https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExanlzaXJncW4zaXZyZXBpcm9mYzl1cTdhaGJxaWYxNWR1NWV3MjZ2aCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l2JhIUyUs8KDCCf3W/giphy.gif");
	background-size: cover;
	text-align: center;
  height: 100%;
}
